...
const Home = () => {
    return (
        <div className="px-2 md:px-4 overflow-hidden relative text-gray-900" style={{ background: `url(${designer}) no-repeat`, backgroundPositionX: '100%' }}>
            <div className="items-center">
                ...
                <div className="flex items-center justify-center mb-4 h-screen">
                    <div>
                        ...
                        <div className="text-center">
                            <button className="py-3 px-4 text-xl bg-gray-800 text-white rounded mr-3 font-bold hover:bg-gray-900 shadow">Get Started Now</button>
                            <button className="py-3 px-4 text-xl bg-white text-gray-800 rounded font-bold hover:bg-gray-900 hover:text-white shadow">Try Demo</button>
                        </div>
                    </div>
                </div>
            </div>
